/*
  # Create user question attempts table
  ...
  3. Indexes
    - Index on user_id and question_id for fast lookups
    - Index on user_id and is_correct for filtering solved questions
*/

-- Create the user_question_attempts table
