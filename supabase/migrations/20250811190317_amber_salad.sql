/*
  # Add user question attempts tracking
  ...
  3. Indexes
    - Composite index on user_id and question_id for fast lookups
...
CREATE INDEX IF NOT EXISTS idx_user_question_attempts_correct 
